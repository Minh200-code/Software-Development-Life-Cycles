...
<?php include 'navbar.php'; ?>
		...
		<section class="ftco-section ftco-wrap-about ftco-no-pt ftco-no-pb">
				...
				<p>Discover a new level of comfort and hospitality at Harbor Lights Hotel. Whether you are traveling for business or leisure, our modern rooms and dedicated staff ensure a memorable stay. Book your room today and enjoy exclusive amenities and a prime location in the city.</p>
			...
			<div class="col-md-7 py-5 pl-md-5">
				<div class="py-md-5">
					...
					<div class="item">
						...
						<div class="text">
							<p class="mb-4">“The staff were incredibly friendly and the room was spotless. I had a wonderful stay and will definitely come back!”</p>
						</div>
						<div class="d-flex">
					...
					<div class="item">
						<div class="testimony-wrap pb-4">
						<div class="text">
							<p class="mb-4">“Spacious rooms, comfortable beds, and a beautiful view. Highly recommended for families!”</p>
						</div>
						<div class="d-flex">
					...
					<div class="item">
						<div class="testimony-wrap pb-4">
						<div class="text">
							<p class="mb-4">“I loved the modern amenities and the relaxing atmosphere. Will book again for my next business trip.”</p>
						</div>
						<div class="d-flex">
					...
					<div class="item">
						<div class="testimony-wrap pb-4">
						<div class="text">
							<p class="mb-4">“The location was perfect, close to everything I needed. The breakfast was delicious and the service was top-notch!”</p>
						</div>
						<div class="d-flex">
						...
						<div class="room-wrap d-md-flex ftco-animate">
							...
							<div class="half left-arrow d-flex align-items-center">
								<div class="text p-4 text-center">
									...
									<h3 class="mb-3"><a href="rooms.php">King Room</a></h3>
		...
		<div class="container">
			...
			<div class="col-md">
				...
				<p>Enjoy a relaxing atmosphere, professional service, and the best value for your trip at Harbor Lights Hotel.</p>
			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<ul>
						...
						<li><a href="#"><span class="icon icon-phone"></span><span class="text">+84 392 3929 21</span></a></li>
